...
<main class="container">
    <form class="container__formulario" enctype="multipart/form-data" method="post">
        ...
        <div class="formulario__campo">
            <label class="campo__etiqueta" for="image">Imagen do vídeo</label>
            <input type="file" name="image" accept="image/*" value="<?= $video?->title; ?>" class="campo__escrita"  placeholder="Neste campo, dê o nome do vídeo" id='image' />
        </div>
